					...
					<section className="py-20 md:py-32 border-b">
						<div className="container mx-auto text-center px-4">
							...
							<p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto mb-10">
								Konbini (Japanese for "convenience store") is your go-to
								solution for securely storing, managing, and sharing sensitive
								information within your organization. Like a well-organized
								bento box, Konbini keeps your secrets neatly compartmentalized
								and protected.
							</p>
...
cd konbini`}</code>
									...
									<div>
										<p className="mb-2">
											3. Create a .env file in the project root with the
											following variables:
										</p>
										<pre className="bg-black text-white p-4 rounded overflow-x-auto">
											<code>{`PORT=8080
